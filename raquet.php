<?php
	$carecenter = array('Name' => 'Pinellas', 
						'Short' => 'pinellas');
	$doctor = array('Lastname' => 'Raquet', 
					'Firstname' => 'Robert',
					'NameTitle' => 'Robert Raquet, M.D.',
					'PhotoName' => 'raquet',
					'Undergrad' => 'SUNY at Stony Brook',
					'Medical' => 'University of Health Sciences<br>The Chicago Medical School',
					'Intern' => 'Georgetown University',
					'Board' => 'American Board of Internal Medicine',
					'Quote' => 'I like to partner with my patients to individualize a care plan that will help optimize their health.  I enjoy empowering the patient and providing them with guidance, motivation and hope while educating them about their medical condition.'
					);
?>
