...
<title>The Learning Center | Santa Barbara Care Center classes</title>
...
<form method="post" name="openLearningCenterForm" target="LearningCenterWindow" action="learning-center.php">
  ...
  <p class="center">SANTA BARBARA CARE CENTER<br />
    <span class="text">1575 Santa Barbara Boulevard<br />
