	...
	<div id="content">	
		...
		?>
	  	<p><img src="images/line.png" width="980" height="30" /></p>
	  		Presentations are held at the Savannah Center.  Tickets can be acquired for free through the box office.
	  		<?php 
	  			include "community-health-presentations-calendar.php";

	      		$classesToShow = count($presentation); // show all

				include "upcoming-community-health-presentations-new.php";
			?>
	</div>
