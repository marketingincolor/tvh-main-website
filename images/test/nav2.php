...
<div id="navigation_horiz">
                <ul>
                    <li>
                      ...
                      <a href="../links.php">links</a>                      </div><!-- .dropdown_menu -->  
                    </li>
                    <li>
                        ...
                        <div class="dropdown" id="dropdown_two">            
                          ...
                          <a href="../TVHCC map.pdf" target="_blank">locations</a><br />
                          <a href="../faqs.php">FAQs</a><br />
                          <a href="../insurance.php">accepted insurance</a><br />
                          </a></span><a href="../photos/lobby.html" onclick="return popitup('photos/lobby.html')">photo slideshow</a>
                          
                          <p>
                          <a href="../colonycenter.php">COLONY CARE CENTER</a></br>
                          <a href="../belleviewcenter.php">BELLEVIEW CARE CENTER</a></p>
</div><!-- .dropdown_menu -->   
                    </li>
                           <li>
                        ...
                        <div class="dropdown" id="dropdown_two">            
                          ...
                          <!-- .dropdown_menu -->   
                                      ...
                                      <li>
                    	<a href="staffnews.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('careers','','../images/menu/btn_4_ro.png',1)" class="navlink"><img src="../images/menu/btn_4.png" name="careers"width="175" height="38" align="absmiddle" id="careers"/></a>
                                     	</li>
              </ul>
