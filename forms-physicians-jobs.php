...
<form class="jotform-form" action="forms-submit.php" method="post" enctype="multipart/form-data" name="physician" id="physician" accept-charset="utf-8">
  <input type="hidden" name="ReturnTo" value="careers.php">
  <input type="hidden" name="FormName" value="Physician Jobs">
  <div class="form-all">
    <ul class="form-section">
      <li class="form-line form-line-column form-col-1" data-type="control_checkbox" id="id_16">
        <label class="form-label form-label-top" id="label_16" for="input_16"> Title </label>
        <div id="cid_16" class="form-input-wide jf-required">
          <div class="form-single-column">
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_16_0" name="q16_title[]" value="MD/DO" />
              <label for="input_16_0"> MD/DO </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_16_1" name="q16_title[]" value="PA" />
              <label for="input_16_1"> PA </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_16_2" name="q16_title[]" value="NP" />
              <label for="input_16_2"> NP </label>
            </span>
            <span class="clearfix">
            </span>
          </div>
      ...
      <li class="form-line jf-required" data-type="control_fullname" id="id_4">
        ...
        <div id="cid_4" class="form-input-wide jf-required">
          ...
          <span class="form-sub-label-container" style="vertical-align: top">
            <input class="form-textbox validate[required]" type="text" size="15" name="q4_fullName[last]" id="last_4" title="Last Name"/>
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_10">
        ...
        <div id="cid_10" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_10" name="q10_desiredPosition" size="20" value="" title="Desired Position"/>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 jf-required" data-type="control_fileupload" id="id_12">
        ...
        <div id="cid_12" class="form-input-wide jf-required">
          <input class="form-upload validate[required]" type="file" id="input_12" name="q12_pleaseAttach12" file-accept="pdf, doc, docx, xls, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" file-maxsize="10239" file-minsize="0" file-limit="0" />
        </div>
      </li>
      <li class="form-line" data-type="control_checkbox" id="id_17">
        ...
        <div id="cid_17" class="form-input jf-required">
          <div class="form-single-column">
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_17_0" name="q17_howDid17[]" value="Florida Family Physician" />
              <label for="input_17_0"> Florida Family Physician </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_17_1" name="q17_howDid17[]" value="Direct Mail" />
              <label for="input_17_1"> Direct Mail </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_17_2" name="q17_howDid17[]" value="Military Media" />
              <label for="input_17_2"> Military Media </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_17_3" name="q17_howDid17[]" value="Web ad" />
              <label for="input_17_3"> Web ad </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_17_4" name="q17_howDid17[]" value="Conference" />
              <label for="input_17_4"> Conference </label>
            </span>
            <span class="clearfix">
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <input type="checkbox" class="form-checkbox" id="input_17_5" name="q17_howDid17[]" value="Word of Mouth" />
              <label for="input_17_5"> Word of Mouth </label>
            </span>
            <span class="clearfix">
            </span>
          </div>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="21363732712953" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "21363732712953-21363732712953";
  </script>
</form>
