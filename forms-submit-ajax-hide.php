...
<?php
	...
	if ($FormName == "MedicareReferred") {
		$thankYouMessage = "aThank you, your message has been sent.  Have anyone you'd else like to refer?  <b><a href='medicare/refer.php' target='_parent'>Just click here</a></b> to refresh this page and complete the form again to send to another friend!";
