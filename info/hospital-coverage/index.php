                        ...
                        <div class="row collapse">
                            <div class="circle-wrapper-blue">
                                <div class="circle-container-blue">
                                    <h2>Did you know?</h2>
                                    <p>Cleveland Clinic locations in both Weston and West Palm Beach, Florida, accept UnitedHealthcare Medicare Advantage plans.</p>
                                </div>
                            </div>
                        </div>
                    </div>
