<?php
	$carecenter = array('Name' => 'Pinellas', 
						'Short' => 'pinellas');
	$doctor = array('Lastname' => 'Kaplan', 
					'Firstname' => 'Fred',
					'NameTitle' => 'Fred M. Kaplan, M.D.',
					'PhotoName' => 'kaplan',
					'Undergrad' => 'Colgate University<br>Hamilton, NY',
					'Medical' => 'George Washington University<br>School of Medicine & Health Sciences<br>Washington, DC',
					'Intern' => 'Albany Medical Center<br>Albany, NY',
					'Board' => 'American Board Internal Medicine',
					'Quote' => 'I believe that in order to practice good medicine, one must be a good listener.  All diagnoses begin with taking a good history. A physician must also be able to communicate with patients in language that they will understand'
					)
?>
