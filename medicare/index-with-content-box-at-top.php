...
body {
    ...
    <script>
      $(document).ready(function () {
        ...
        $("#medicareForm").validity(function() {
          $("#first_4").require();
...
<div class="text" id="content">
  ...
  <div style="width:600px">
    ...
    <span style="font-weight:bolder; font-size:20px">Request a FREE Insurance Checkup!</span><br><br>
    ...
    <div id="FormDiv">
      <?php 
        include "forms-medicare-box-at-top.php"; 
      ?>
    </div>
