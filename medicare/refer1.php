...
<div class="text" id="content">
  ...
  <div style="width:600px">
	...
	<a name="formSection">
    <iframe id="ContactFormFrame" onload="window.parent.scrollTo(0,0)" allowtransparency="true" src="forms-refer.php" frameborder="0" style="width:650px; height:400px; border:none;" scrolling="no"></iframe>
	</a>
