...
if ($FormName == "NewPatient") {
	$to = "Jillian.O'Neill@thevillageshealth.com, Beth.Garrett@thevillageshealth.com";
}
...
if ($FormName == "Free Insurance Checkup Request") {
	//$to = "jparrish@marketingincolor.com";
	$bcc = "david.huffman@thevillagestsg.com";

	$message = "This person has requested information about getting a Free Insurance Checkup at The Villages Health Care Center. Please contact as soon as possible by phone number provided. If phone contact is unsuccessful, try email as an alternate.\n\n" . $message;
}
if ($FormName == "MedicareReferred") {
	...
	$message = "I signed up for a free insurance checkup at The Villages Health:\nwww.thevillageshealth.com/medicare" . "\n" . "See what you think!";
	if ($OptionalMessage <> "") {
		$message .= "\n\n";
...
If you have any questions, feel free to call us at 352-753-6200
...
If you know of any Villager friends who may be interested in learning more about their Medicare options, please visit this page to find out how you can send them information: http://thevillageshealth.com/medicare/refer.php 
...
<?php
	...
	############ UPDATE LEARNING CENTER REGISTERED
	if ($FormName == "Free Insurance Checkup Request") {
		$s = simplexml_load_file('signup.xml');
			# add node
	...
	if ($FormName == "MedicareReferred") {
		$s = simplexml_load_file('refer.xml');
			# add node
	...
	if ($FormName == "Free Insurance Checkup Request") {
		$thankYouMessage = 'Thank you for your request! We will contact you at our earliest opportunity.  If you know of any Villager friends who may be interested in getting a FREE Insurance Checkup, <b><a href="medicare/refer.php" target="_parent">please click here</a></b>.';
	}
	if ($FormName == "MedicareReferred") {
		$thankYouMessage = "Thank you, your message has been sent.  Have anyone you'd else like to refer?  <b><a href='medicare/refer.php' target='_parent'>Just click here</a></b> to refresh this page and complete the form again to send to another friend!";
...
?>
	...
	<br>
	<div id="ThankYouDiv" style="-webkit-box-shadow: 0px 2px 5px -1px rgba(0,0,0,0.65); -moz-box-shadow: 0px 2px 5px -1px rgba(0,0,0,0.65); box-shadow: 0px 2px 5px -1px rgba(0,0,0,1.65); border:1px solid black; padding:7px;">
